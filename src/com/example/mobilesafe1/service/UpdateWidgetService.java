...
import com.example.mobilesafe1.receiver.MyAppWidgetProvider;
...
//				Log.i(tag, "5秒一次的定时任务现在正在运行..........");
	...
	protected void updateAppWidget() {
		...
		remoteViews.setTextViewText(R.id.tv_process_widget_process_count, "进程总数:"+ProcessInfoProvider.getProcessCount(this));
		//4.显示可用内存大小
		String strAvailSpace = Formatter.formatFileSize(this, ProcessInfoProvider.getAvailSpace(this));
		remoteViews.setTextViewText(R.id.tv_process_widget_process_memory, "可用内存:"+strAvailSpace);
		...
		remoteViews.setOnClickPendingIntent(R.id.ll_process_widget_root, pendingIntent);
		...
		remoteViews.setOnClickPendingIntent(R.id.btn_process_widget_clear,broadcast);
